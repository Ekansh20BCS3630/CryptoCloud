    ...
    if ($("#users-datatable").length) {
        new DataTable(document.querySelector("#users-datatable"), {
            ...
            data: [{
                ...
                name: '<span class="has-dark-text dark-inverted is-font-alt is-weight-600 rem-90">Filename</span>',
                position: "2MB",
        ...
        setTimeout((function() {
            "development" === env && changeDemoImages(), adjustDropdowns(), customizeDatatable()
        }), 1e3)
    }
